...
const SearchComponent = () => {
    ...
    const getDeepSpaceData = async () => {
        ...
        try {
            ...
            const response = await axios.get(`http://localhost:8000/deepspaceobject/${searchQuery}`) // <-- just searches existing db in django admin -> NOT what we want // testing local api endpoint for dev
